...
My general platform/software stack for this website:
...
- I use ChatGPT separately as well for article editing and grammar checking.
- My content (words not the code) is written by me, but AI tools are my editors.
...
- My website theme is a [custom-built Hugo theme](https://github.com/kylecoberly/hugo-opensourcesourcekyle-theme) tailored to my liking and constantly updated.
...
- Finally, I personally code off of an obscure operating system called [Arch Linux: Linux Distribution](https://archlinux.org/) because I was a l33t h4x0r back in the day; now, I love it and can't stand to use anything else.
